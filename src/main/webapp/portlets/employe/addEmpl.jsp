...
<aui:form name="addEmpl" action="<%= addEmpl %>">
    ...
    <aui:input name="secondName" id="secondName" label="Employe second name"/>
    ...
    <aui:input name="birthday" cssClass="DatePicker" type="text" id="birthday" placeholder="Day, Mon dd, yyyy"/>
    ...
    <aui:input name="startWork" cssClass="DatePicker" type="text" id="startWork" placeholder="Day, Mon dd, yyyy"/>
    <aui:input name="salary" id="firstName" label="Employe salary" required="true" >
        <aui:validator name="digits"></aui:validator>
    </aui:input>
    <aui:input name="workPhone" id="workPhone" label="Employe work phone number">
        <aui:validator name="digits"></aui:validator>
    </aui:input>
