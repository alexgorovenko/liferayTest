...
import com.EmployeesDB.NoSuchBankException;

import com.EmployeesDB.model.Bank;
import com.EmployeesDB.model.impl.BankImpl;
import com.EmployeesDB.model.impl.BankModelImpl;
...
public class BankPersistenceImpl extends BasePersistenceImpl<Bank>
    ...
    @Override
    public Bank updateImpl(com.EmployeesDB.model.Bank bank)
    ...
    protected Bank toUnwrappedModel(Bank bank) {
        ...
        bankImpl.setAdres(bank.getAdres());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.EmployeesDB.model.Bank")));
