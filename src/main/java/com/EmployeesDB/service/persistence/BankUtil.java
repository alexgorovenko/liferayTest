...
public class BankUtil {
    ...
    * @param bank the bank
    */
    public static void cacheResult(com.EmployeesDB.model.Bank bank) {
    ...
    */
    public static void cacheResult(
        java.util.List<com.EmployeesDB.model.Bank> banks) {
    ...
    * @return the new bank
    */
    public static com.EmployeesDB.model.Bank create(long bankId) {
    ...
    * @throws com.EmployeesDB.NoSuchBankException if a bank with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.EmployeesDB.model.Bank remove(long bankId)
        throws com.EmployeesDB.NoSuchBankException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().remove(bankId);
    }

    public static com.EmployeesDB.model.Bank updateImpl(
    ...
    /**
    * Returns the bank with the primary key or throws a {@link com.EmployeesDB.NoSuchBankException} if it could not be found.
    *
    * @param bankId the primary key of the bank
    * @return the bank
    * @throws com.EmployeesDB.NoSuchBankException if a bank with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.EmployeesDB.model.Bank findByPrimaryKey(long bankId)
        throws com.EmployeesDB.NoSuchBankException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.EmployeesDB.model.Bank fetchByPrimaryKey(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.EmployeesDB.model.Bank> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static BankPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (BankPersistence) PortletBeanLocatorUtil.locate(com.EmployeesDB.service.ClpSerializer.getServletContextName(),
