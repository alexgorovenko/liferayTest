...
public class EmployeesLocalServiceClp implements EmployeesLocalService {
    ...
    public com.EmployeesDB.model.Employees addEmployees(
        ...
        return (com.EmployeesDB.model.Employees) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.EmployeesDB.model.Employees> getEmployeeses(
        ...
        return (java.util.List<com.EmployeesDB.model.Employees>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.EmployeesDB.model.Employees> findByBankId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { bankId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
